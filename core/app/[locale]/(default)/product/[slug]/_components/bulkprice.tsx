...
//           </p>
//           <div id="hubspot-form">
//           <script charset="utf-8" type="text/javascript" src="//js-eu1.hsforms.net/forms/embed/v2.js"></script></div> {/* Placeholder for the form */}
//         </div>
//       </div>
//     );
//   }
...
const Bulk: React.FC<Props> = ({ product }) => {
  ...
  // Use useEffect to load the HubSpot form
  useEffect(() => {
    // Only inject the HubSpot script if the element is available
