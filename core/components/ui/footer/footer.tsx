...
const Footer = ({
  ...
  <div className="">
    ...
    <footer className={cn('2xl:container 2xl:mx-auto footer-section', className)} {...props}>
      <nav className="auto-cols-frr grid flex-auto gap-8 sm:grid-flow-col">
        <article
          className="emthemesModez-newsletterForm"
        ...
        >
          ...
          >
            <h5 className="footer-info-heading" id="headingin" style={{ margin: 0 }}>
              Subscribe Today
            </h5>
            <p id="font size" style={{ margin: 0 }}>
              Be the first to know about exclusive deals, new product lines, company announcements,
              and industry news.
            </p>
            <form
              className="form"
            ...
            >
              ...
              >
                ...
                <div className="form-field" style={{ display: 'flex', alignItems: 'center' }}>
                  <label className="form-label is-srOnly" htmlFor="nl_email"></label>
                  <div
                    className="form-prefixPostfix wrap"
                    id="warp"
                    style={{ display: 'flex', alignItems: 'center' }}
                  >
                    <input
        ...
        <nav className="grid flex-auto auto-cols-fr gap-8 sm:grid-flow-col">
          {sections.map((section) => (
            <div key={section.title}>
              <h3 className="mb-4 text-lg font-bold" id="footer headings">
                Navigation{' '}
              </h3>
              ...
              <ul className="downaload">
                <li className="payment">
                  <a
                    ...
                    title="Get the Quality Bearings Online App on Google Play Store"
                    target="_blank"
                  >
                    <img
                ...
                <li>
                  <a
                    ...
                    title="Get the Quality Bearings Online App on The Apple App Store"
                    target="_blank"
                  >
                    <img
      ...
      <section
        className="hidden justify-between gap-8 border-t border-gray-200 px-4 py-6 sm:px-10 lg:flex lg:px-12 2xl:px-0"
        id="borderfooter"
      >
        <p className="textscopy">{copyright}</p>
