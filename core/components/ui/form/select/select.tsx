    ...
    return (
      <SelectPrimitive.Root {...props}>
        <SelectPrimitive.Trigger
          aria-label={label}
          className={cn(
            'border border-[#dcdcdc] capitalize pop-up-container h-[50px] p-2.5 text-gray-600 rounded-[3px] font-normal text-[16px] tracking-[0.5px] group relative flex w-full items-center justify-[unset] gap-[20px] text-base hover:border-primary focus-visible:border-primary focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/20 disabled:bg-gray-100 disabled:hover:border-gray-200 data-[placeholder]:text-gray-500',
            error &&
