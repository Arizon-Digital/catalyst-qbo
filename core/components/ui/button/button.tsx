    ...
    return (
      <Comp
        className={cn(
          ...
          variant === 'primary' &&
            'bg-primary text-white hover:border-secondary hover:bg-secondary disabled:bg-gray-400 disabled:hover:border-gray-400 disabled:hover:bg-gray-400  text-white',
          variant === 'secondary' &&
            'bg-transparent text-primary hover:border-secondary hover:bg-secondary hover:bg-opacity-10 hover:text-secondary disabled:text-gray-400 disabled:hover:border-gray-400 disabled:hover:bg-transparent disabled:hover:text-gray-400  text-white',
          variant === 'subtle' &&
